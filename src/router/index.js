...
export const asyncRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'about-us',
        component: () => import('@/views/setting/about-us'),
        name: 'AboutUs',
        meta: { title: 'about-us', icon: 'guide' }
      },
      {
        path: 'site',
        component: () => import('@/views/setting/site'),
        name: 'Site',
        meta: { title: 'site', icon: 'international' }
      }
    ]
  },
  // {
  ...
  //       name: 'AboutUs',
  //       meta: { title: 'about-us', icon: 'guide', noCache: true }
  //     }
  //   ]
  // },
